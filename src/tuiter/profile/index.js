        ...
        <>
            <div className="position-relative">
                <div className="row">
                    ...
                    <div className="col col-10"><span className="fs-4 fw-bold">{profile.firstName} {profile.lastName}</span>
                ...
                <div className="row">
                    ...
                    <div className="col col-4">
                        <br/>
                        <button type="button" className="btn btn-light float-end rounded-pill">Edit Profile</button>
                    </div>
                </div>
            </div>
            <div>
