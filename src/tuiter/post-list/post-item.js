    ...
    <li className="list-group-item wd-bg-black">
        <div className="row">
            <div className="col col-2">
                <div><img className="float-start rounded-circle" height="60px" src={`/images/${post.profileImg}`}/></div>
            </div>
            <div className="col-10">
                ...
                <div className="rounded-3 border border-secondary">
                    <img className="rounded-2 " width="100%" src={`/images/${post.postImg}`}/>
                ...
                <div className="row  my-2">
                    <div className="col-3 mx-auto text-secondary">
                        <a href="#" className="px-1"><i className="bi bi-chat-left-heart text-secondary"></i></a> <span>{post.comments}</span>
                    </div>
                    <div className="col-3 mx-auto text-secondary">
                        <a href="#" className="px-1"><i className="bi bi-repeat text-secondary"></i></a> <span>{post.tweets}</span>
                    </div>
                    <div className="col-3 mx-auto text-secondary">
                        <a href="#" className="px-1"><i className="bi bi-suit-heart-fill text-secondary"></i></a> <span>{post.likes}</span>
                    </div>
                    <div className="col-3 mx-auto text-secondary">
                        <a href="#" className="px-1"><i className="bi bi-box-arrow-up text-secondary"></i></a>
                    </div>
                </div>
            </div>
        </div>     
